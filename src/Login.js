    ...
    <div className="container mx-auto w-4/5 sm:w-2/4 lg:w-1/4 mt-48">
      ...
      <form onSubmit={handleLogin} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mb-6">
          ...
          <input className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" name="password" type="password" placeholder="password" />
